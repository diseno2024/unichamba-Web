    ...
    return (
        <>
            {ofertasLaborales.map((oferta) => (
                <div key={oferta.id} className={location.pathname === '/OfferExploreStudent' ? 'min-h-[225px] py-3 px-5 flex justify-between mb-6 border-b-[1px] border-black/40' : 'py-3 px-3 flex justify-between mb-3 border-b-2 hover:bg-Malachite/10'}>
