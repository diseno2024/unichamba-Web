                ...
                ofertasLaborales.map((oferta) => (
                    location.pathname === '/OfferExploreStudent' ? (
                        <NavLink key={oferta.id} to={`/anuncios/${oferta.id}`}
                            className='lg:min-h-[235px] lg:min-w-[200px] py-3 px-5 flex justify-between mb-6 lg:border-b-[1px] lg:border-black/40 hover:bg-Malachite/15 cursor-pointer '>
                            <div className='flex items-center gap-5 relative'>
                                {/* foto (visible en pantallas grandes) */}
                                <div className='lg:block md:block hidden min-h-[170px] min-w-[190px] items-center justify-start'>
                                ...
                                <div className='min-h-[195px] grid  justify-items-end'>
                                    ...
                                    <div className="mb-5 lg:block md:block hidden">
                                        ...
                                        <p className='text-md font-normal pt-3 text-Dark-Blue md:text-md'> <strong>Publicado por:</strong> {oferta.quienPublica}</p>
                                    </div>
                                    {/* texto (visible en pantallas grandes) */}
                                    <div className="mb-5 block sm:hidden">
                                        ...
                                        <p className='text-sm font-normal pt-3 text-Dark-Blue md:text-md'> <strong>Publicado por:</strong> {oferta.quienPublica}</p>
                                    </div>
