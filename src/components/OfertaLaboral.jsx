...
//             if (carreraSeleccionada != null) {
//                 const anunciosSeleccionados = query(querySnapshot, where('carrera', 'array-contains', carreraSeleccionada));
//                 const resp = await getDocs(anunciosSeleccionados);
//                 setOfertasLaborales(resp.docs.map((doc) => ({ ...doc.data(), id: doc.id })));
//             } else {
//                 const resp = await getDocs(querySnapshot);
//                 setOfertasLaborales(resp.docs.map((doc) => ({ ...doc.data(), id: doc.id })));
//             }
//         } catch (error) {
//             console.error("Error fetching documents: ", error);
